...
namespace ULPFTest\DataSource\Database;

// Includes
require_once __DIR__ . '/../../../ULPF/DataSource/Database/Client.php';
require_once __DIR__ . '/../../../ULPF/DataSource/Database/Exception.php';

use ULPF\DataSource\Database\Client;
use ULPF\DataSource\Database\Exception;

/**
 * @uses \ULPF\DataSource\Database\Exception
 * 
 * @coversDefaultClass \ULPF\DataSource\Database\Client
 * @covers ::<protected>
 */
class ClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getClientInstance()
    {
        ...
        $this->assertInstanceOf('\ULPF\DataSource\Database\Client', $client);
    ...
    public function fetchOneSuccess()
    {
        ...
        $client = $this->getMockBuilder('\ULPF\DataSource\Database\Client')
            ->disableOriginalConstructor()
     ...
     * 
     * @uses \ULPF\DataSource\Database\Client::getQueryLog
     * 
     * @covers ::fetchOne
     * @test
     */
     ...
     * 
     * @uses  \ULPF\DataSource\Database\Client::__construct
     * 
     * @covers ::query
     * @test
     */
    public function querySuccess()
    {
        ...
        // Get client
        $client = new \ULPF\DataSource\Database\Client($mysqliMock);
